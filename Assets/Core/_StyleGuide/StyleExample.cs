...
// - Use the GameSystemsCookbook namespace for general scripts
// - Use the GameSystemsCookbook.Demos namespace for app-specific scripts (e.g. GameSystemsCookbook.Demos.Pong)
...
namespace StyleSheetExample
{
    ...
    public class GameIconsSO : ScriptableObject
    {
        ...
        private List<RarityIcon> m_RarityIcons;
