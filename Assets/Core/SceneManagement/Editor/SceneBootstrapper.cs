...
namespace GameSystemsCookbook
{
    ...
    public class SceneBootstrapper
    {
        ...
        private const string k_LoadBootstrapMenu = "GameSystems/Load Bootstrap Scene On Play";
        private const string k_DontLoadBootstrapMenu = "GameSystems/Don't Load Bootstrap Scene On Play";
